...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RecurlyIPN.username'
        db.delete_column('message_recurlyipn', 'username')


    def backwards(self, orm):
        
        # Adding field 'RecurlyIPN.username'
        db.add_column('message_recurlyipn', 'username', self.gf('django.db.models.fields.CharField')(default='test', max_length=255), keep_default=False)
    ...
    models = {
        ...
        'message.mailbox': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_scrape': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 4, 7, 22, 44, 575750)'}),

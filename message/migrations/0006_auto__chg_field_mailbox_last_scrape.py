...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MailBox.last_scrape'
        db.alter_column('message_mailbox', 'last_scrape', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'MailBox.last_scrape'
        db.alter_column('message_mailbox', 'last_scrape', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'message.mailbox': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_scrape': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 28, 7, 48, 52, 470783)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('message_account', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('mode', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('paid_until', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('message', ['Account'])


    def backwards(self, orm):
        
        # Deleting model 'Account'
        db.delete_table('message_account')

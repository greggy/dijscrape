...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RecurlyIPN'
        db.create_table('message_recurlyipn', (
            ...
            ('date_add', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('message', ['RecurlyIPN'])


    def backwards(self, orm):
        
        # Deleting model 'RecurlyIPN'
        db.delete_table('message_recurlyipn')
    ...
    models = {
        ...
        'message.mailbox': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_scrape': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 4, 5, 10, 46, 117479)'}),

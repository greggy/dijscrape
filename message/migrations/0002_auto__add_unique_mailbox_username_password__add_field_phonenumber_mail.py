...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'MailBox', fields ['username', 'password']
        db.create_unique('message_mailbox', ['username', 'password'])

        # Adding field 'PhoneNumber.mailbox'
        db.add_column('message_phonenumber', 'mailbox', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['message.MailBox']), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'MailBox', fields ['username', 'password']
        db.delete_unique('message_mailbox', ['username', 'password'])

        # Deleting field 'PhoneNumber.mailbox'
        db.delete_column('message_phonenumber', 'mailbox_id')
    ...
    models = {
        ...
        'message.mailbox': {
            'Meta': {'unique_together': "(('username', 'password'),)", 'object_name': 'MailBox'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
